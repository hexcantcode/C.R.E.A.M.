...
export function Particles({
  ...
  aperture,
  focus,
  size = 64, // reduced from 128 to 64 for much sparser particle distribution (4,096 total particles)
  noiseScale = 1.0,
  noiseIntensity = 0.5,
  timeScale = 0.5,
  pointSize = 2.0,
  ...
  const miladyTexture = useTexture("/milady.png")
  ...
  const dofPointsMaterial = useMemo(() => {
    ...
    m.uniforms.uTexture.value = miladyTexture
    return m
  }, [simulationMaterial, miladyTexture])
